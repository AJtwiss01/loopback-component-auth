...
module.exports = function componentLoader(app, spec) {
  ...
  function setupAuthProvider(name, options) {
    ...
    //   providerOptions.successRedirect = utils.makeSuccessRedirect(name, providerOptions, link, contextRoot);
    //   providerOptions.failureRedirect = utils.makeFailureRedirect(name, providerOptions, link, contextRoot);
    // }
