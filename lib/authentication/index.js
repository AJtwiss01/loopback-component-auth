...
module.exports = function setupCustomAuthScheme(app, appAuthDir, models, authType, name, options) {
  ...
  const verifyFunction = authTypeModule.makeVerifyFunction(providerOptions, models, makeLoginCallback);
